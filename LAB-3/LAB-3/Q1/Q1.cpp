...
c_00.clear();c_01.clear();c_10.clear();c_11.clear();a00.clear();a01.clear();a10.clear();a11.clear();b00.clear();b01.clear();b10.clear();b11.clear();
    return c;
}
...
Mx strassen(const Mx &A, const Mx &B) {
    ...
    if (pow(2, v) != n1) {
        n1 = pow(2, v + 1);
    } // padding for matrix of size other than 2^i
